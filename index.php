        ...
        <div class="container">
          <div class="row row-header">
            <div class="col-12 col-sm-6">
              <h1 class="text-white">Mkulima Bora Agriculture Portal</h1>
              <p class="text-white">
...
const apiKey = "sk-UaPt-e_hv6xRho-M1mbBqeVY3g6HZFBC69W7CBtMGnT3BlbkFJXl_DH5A_Qj_FqE5_BZJKayU2K6ctmXECahNmKXFMEA";   // Enter your apikey here
