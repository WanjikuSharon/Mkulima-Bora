...
$districts = json_decode($data); // decode the JSON feed

$district_weather_id = 0;

foreach ($districts as $district) {
    if ($district->name == trim($District_name_farmer) && $district->country == 'KE') { // Ensure the country is Kenya
...
if ($district_weather_id <= 0) {
    $district_weather_id = 184745; // Default to Nairobi, Kenya if no match found
}

$city_weather_id = strval($district_weather_id);

date_default_timezone_set("Africa/Nairobi"); // Set timezone to Kenya
$apiKey = "14ddd1a6988f7889815fdb275631560f"; // Your API KEY 
                                        ...
                                        <?php foreach($forecast as $f): ?>
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    ...
                                                    <?php echo $f->main->temp_max; ?> &#8451; &nbsp; <span class="min-temperature"><?php echo $f->main->temp_min; ?> &#8451;</span>
                                                </td>
